angular.module('ui.multiselect', [
  'directives/multiselect.tpl.html'
])
  ...
  .directive('multiselectPopup', ['$document', function ($document) {
    return {
      ...
      scope: false,
      replace: true,
      templateUrl: 'directives/multiselect.tpl.html',
...
angular.module('directives/multiselect.tpl.html', [])

  .run(['$templateCache', function($templateCache) {
    $templateCache.put('directives/multiselect.tpl.html',
