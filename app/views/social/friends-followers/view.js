...
angular.module('myApp.view.social.friendsFollowers', ['ngRoute', 'myApp.filter', 'myApp.services', 'myApp.view.filter', 'myApp.view.councillors'])

    .config(['$routeProvider', function ($routeProvider) {

        $routeProvider.when('/social/friends-followers', {
            templateUrl: 'views/social/friends-followers/template.html',
            controller: 'SocialFriendsFollowersController',
    ...
    .controller('SocialFriendsFollowersController', ['$scope', 'QueriesService', '$location', '$interval', function ($scope, QueriesService, $location, $interval) {

        $scope.title = "Liens entre parlementaires";
